...
class FlatInhomogeneousUniverseLCDM : public FlatHomogeneousUniverseLCDM {
 ...
 public:
  ...
  vector<vector<double> > return_LOS_joint_PDF_kappa_kappa(double theta, double f_NL, double var_NL_rescale, double var_kappa_noise_1, double var_kappa_noise_2, vector<double> w_values, vector<double> lensing_kernel_values_1, vector<double> lensing_kernel_values_2);
