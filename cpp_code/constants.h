...
enum BIAS_MODEL {EULERIAN, LAGRANGIAN, TABLE};
...
const char *BIAS_MODEL_types[] = {"EULERIAN", "LAGRANGIAN", "TABLE"};
...
//static double maximal_da = 0.0002;
...
//static int N_delta_values_for_PDFs = 512;
...
//static int minimal_n_w = 1000;
//static int minimal_n_w = 300;
//static int minimal_n_w = 150;
//static double maximal_dw = 0.002;
