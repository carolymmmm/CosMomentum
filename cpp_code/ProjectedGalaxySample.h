...
class ProjectedGalaxySample : public GalaxySample {
 ...
 public:
   ...
   ProjectedGalaxySample(FlatInhomogeneousUniverseLCDM* universe, double density_in_arcmin_squared, double b1, double b2, double a0, double a1, double a2, double a_IA, double alph_IA, BIAS_MODEL b_model, const std::vector<std::vector<double>>& nofz_data);
   ~ProjectedGalaxySample();
   
   void set_n_of_w_data(const std::string& n_of_z_input_file);
   void set_n_of_w_data(const std::vector<std::vector<double>>& nofz_data);
   ...
   void set_parameters_projected(double density_in_arcmin_squared, double b1, double b2, double a0, double a1, double a2, double A_IA, double alpha_IA, BIAS_MODEL b_model,
   ...
   const std::vector<double>& return_w_values() const;
   const std::vector<double>& return_lensing_kernel_values() const;

   
 private:

   void set_n_of_w_data_core(const std::vector<std::vector<double>>& nofz_data);
